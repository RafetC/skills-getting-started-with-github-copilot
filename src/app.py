...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["marcus@mergington.edu", "kyle@mergington.edu"]
    },
    "Tennis Club": {
        "description": "Learn and practice tennis skills in a friendly environment",
    ...
    "Music Ensemble": {
        "description": "Perform in school orchestras and bands",
